<template>
  <div id="app">
    ...
    <div class="vi_not" v-if="room_status!=='opened'">
      ...
      <div class="not_tit" v-if="room_status==='overtime'">本次报价已结束，感谢您的参与！</div>
      <div class="not_tit" v-if="room_status==='nostart'">本次报价未开始，敬请期待！</div>
      <div class="not_tit" v-if="room_status==='opened'">当前浏览器不支持流畅的视频报价</div>
...
export default {
  ...
  methods: {
    ...
    // 发送提醒
    toNotice () {
      let noticeText = this.$store.state.LoginType === 1 ? '采购方' : '企业'
