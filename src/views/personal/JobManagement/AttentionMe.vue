      ...
      <div class="box_1">
        ...
        >
          <div class="box_item">
            ...
            <div class="tx3">
              查看：<span class="job">{{ item.first_jobname }}</span> 等{{
                item.jobnum
              }}个案例
              <!-- <div :class=" parseInt(item.has_download) > 0 ? 'right_txt' : 'right_txt not_download'">
...
export default {
  ...
  methods: {
     ...
     */
    toDetail (id) {
      this.$router.push('/company/' + id + '?type=job')
    }
  }
}
</script>
