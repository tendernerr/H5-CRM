<template>
  <div id="app">
    ...
    <div class="notice_bar">视频报价房间仅在报价当天开启，报价时间15天之后自动关闭</div>
    <van-empty
      image="search"
    ...
    <van-dialog v-model="showDetail" title="我的报价详情" show-cancel-button>
      <div class="interview_details_pop_box">
        ...
        <div class="detail_line">
          ...
          <div class="line_right">请在正式报价前30分钟做好报价准备和设备调试，准时参加视频报价</div>
          <div class="clear"></div>
        </div>
  ...
  data () {
    return {
      ...
      navList: [
        ...
        { text: '我的报价', href: '/member/personal/interview', active: false },
        // {
        //   text: '视频报价',
