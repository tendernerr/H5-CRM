<template>
  <div id="app">
    <Head :show_back="'false'">创建项目1/2</Head>
    ...
    <van-popup v-model="showPickerEnterJob" position="bottom">
      <div class="for-pop-title" @click="handleNoJobTime">无案例涉及工艺</div>
      <van-datetime-picker
    ...
    <div v-if="isShowAddExpBox">
      <div class="form_split_title">最近一份案例经历</div>
      <van-field
...
export default {
  ...
  methods: {
    ...
    handleNoJobTime () {
      ...
      this.basic.enter_job_time_name = '无案例涉及工艺'
