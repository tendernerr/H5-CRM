<template>
  <div id="app">
      ...
      <div class="box_2">根据您的项目完整度</div>
      <div class="box_2 pd">正在为您计算采购竞争力</div>
      <div class="box_3">
        <van-slider
          v-model="percent"
          bar-height="8px"
    ...
    <div class="finish_box" v-if="analysis_finish">
      ...
      <div class="txt_1">您的采购竞争力 <span class="level_low">较低</span></div>
      <div class="txt_2">请继续完善项目，助您快速高效报价</div>
