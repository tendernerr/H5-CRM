  ...
  <div id="app" class="my_app">
    ...
    <div class="box_1">
      <div class="box_item" @click="refreshResume">
        <div class="item t1">刷新采购</div>
      </div>
      <div class="box_item" @click="$router.push('/personal/purchasingManagement/purchasingInformation')">
        <div class="item t2">采购信息</div>
      </div>
      <div class="box_item" @click="$router.push('/personal/purchasingManagement/releasePurchase')">
        <div class="item t3">发布采购</div>
      </div>
    </div>
    <div class="form_split_10"></div>
    <div class="box_2" v-if="basic && parseInt(basic.is_display) === 0">
      您的项目当前不公开，企业无法搜到到您的项目哦！
    ...
    <div class="box_title">
      采购管理
      <div class="right_txt">完整度高的项目更容易获得企业青睐</div>
    </div>
    <div class="box_4">
		<div class="box_item" @click="$router.push('/personal/purchasingManagement/myPurchasing')">
		  <!-- <div class="ico_box b1"></div> -->
		  <div class="ico_box szi">{{about.myPurchase}}</div>
		  <div>我的采购</div>
		</div>
		<div class="box_item" @click="handlerJump('/member/personal/jobapply')">
		  <!-- <div class="ico_box b2"></div> -->
		  <div class="ico_box szi">{{about.jobApply}}</div>
		  <div>已邀请</div>
		</div>
		<div class="box_item" @click="handlerJump('/member/personal/attention_me')">
		  <!-- <div class="ico_box b3"></div> -->
		  <div class="ico_box szi">{{about.attentionMe}}</div>
		  <div>被关注</div>
		</div>
		<div class="box_item" @click="handlerJump('/member/personal/interview')">
		  <!-- <div class="ico_box b4"></div> -->
		  <div class="ico_box szi">{{about.companyInterview}}</div>
		  <!-- <div>我的报价</div> -->
		  <div>供应商报价</div>
		</div>
    ...
    <div class="box_title">
      增值服务
      <div class="right_txt">为您解决采购项目无人问津的问题</div>
    </div>
    <div class="box_6">
      <div
        class="box_item t1"
    ...
    <div class="box_7 no_mb">
      <div class="handle_line l6" @click="showSwitchType = true">
        我是供应方
        <div class="right_txt">我是企业/个体户，我要找项目</div>
      </div>
    </div>
    ...
    <van-popup v-model="showLowPop">
      <div class="box_8">
        <div class="tx1">好案例，从好项目开始</div>
        <div class="tx2">完善的项目有助于您的案例匹配</div>
    ...
    <van-popup v-model="showRefreshPop">
      <div class="box_9">
        <div class="tx1">刷新项目</div>
        <div class="tx2">不让项目石沉大海，每天从刷新项目开始</div>
        <div class="btn_wrapper"><div class="btn_right" @click="refreshResume">刷新项目</div></div>
      </div>
    </van-popup>
    <BottomNav></BottomNav>
    <van-popup
...
export default {
  ...
  data () {
    return {
      empty_resume: false,
      pullLoading: false,
      showLowPop: false, // 是否显示项目完整度过低弹窗
      showRefreshPop: false, // 是否显示刷新项目弹窗
      ...
      chatList: [],
		about:{
			...
			jobApply:"",//  我的申请
			attentionMe:"",//  被关注
			companyInterview:"",//  供应商报价
			favJob:"",//  我的收藏
			viewJob:"",//  浏览足迹
			attentionCompany:"",//  关注公司
		},
    }
  },
  computed: {
  ...
  methods: {
    ...
    handlerJump (path) {
      if (this.empty_resume === true) {
        handlerHttpError({code: 50007, message: '请先添加一份项目'})
      } else {
