<template>
  <div id="app">
    ...
    <div class="notice_bar">视频报价房间仅在报价当天开启，在报价时间15天之后自动关闭</div>
    <van-empty
      image="search"
        ...
        >
          <div class="box_item">
            ...
            <div class="tx3" @click.stop="handlerDetail(item)">
              ...
              <div class="time_txt">报价时间：{{ item.interview_time | interviewTimeFilter }}</div>
            </div>
            <div class="tx4">
    ...
    <van-dialog v-model="showDetail" title="我的报价详情">
      <div class="interview_details_pop_box">
        ...
        <div class="detail_line">
          ...
          <div class="line_right">
            请在正式报价前30分钟做好报价准备和设备调试，准时参加视频报价
          </div>
          <div class="clear"></div>
        </div>
  ...
  data () {
    return {
      ...
      navList: [
        ...
        // { text: '视频报价', href: '/member/company/interview_video', active: true },
