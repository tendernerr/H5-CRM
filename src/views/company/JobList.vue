  ...
  methods: {
    ...
    handlerDisplay (item, index) {
      ...
      this.$dialog
        .confirm({
          title: '系统提示',
          message: '确定' + is_display_text + '该案例吗？'
        })
        .then(() => {
          http
    ...
    handlerShowIncrement (item) {
      this.options_increment = [
        { name: '案例置顶', value: 'jobstick', disabled: false },
        { name: '案例紧急', value: 'emergency', disabled: false },
