    ...
    <div class="my_container">
      ...
      <div class="box_2">
        <div class="item">
          <div class="ico"></div>
          <div class="text">
            案例并发 <span>{{ mySetmeal.jobs_meanwhile }}</span>
          </div>
          <div class="link" @click="handlerJobadd">发案例</div>
        </div>
        <div class="item right">
          <div class="ico"></div>
          <div class="text">
            项目点 <span>{{ mySetmeal.download_resume_point }}</span>
          </div>
          <div class="link" @click="$router.push('/resumelist')">搜项目</div>
        </div>
        <div class="clear"></div>
      </div>
      <div class="box_title">
            ...
            this.$dialog
              .confirm({
                ...
                message:
                  ...
                  '，当前可发布案例数为0，建议您立即升级套餐或将暂时不供应商的案例设为关闭！',
