<template>
  <div id="app">
    ...
    <div class="cop_put"><div class="self_content">我的案例匹配度</div></div>
    <div class="box_2">
    ...
    <div class="box_4">
      <div class="cop_put">
        <div class="self_content">全站同行项目类型分布统计</div>
      </div>
      <div class="sheet_box">
        <div class="y">100%</div>
        <div class="x">
    ...
    <div class="box_4">
      <div class="cop_put">
        <div class="self_content">全站同行案例涉及工艺分布</div>
      </div>
      <div class="sheet_box">
        <div class="y">100%</div>
        <div class="x">
    ...
    <div class="box_4">
      <div class="cop_put">
        <div class="self_content">全站同行所属行业分布</div>
      </div>
      <div class="sheet_box">
        <div class="y">100%</div>
        <div class="x">
    ...
    <div class="box_5">
      *以上所展示的数据仅对{{
      ...
      }}的用户样本数据负责，反应的竞争力数据仅供参考。项目完整度越高，采购竞争力越大。
    </div>
  </div>
</template>
