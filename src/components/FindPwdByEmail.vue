<template>
  <div id="app">
    <div class="reg_wrapper">
      ...
      <div class="t_box">
        <router-link class="swb" :class="$route.params.utype==2?'active':''" to="/member/forget/2">采购方用户</router-link>
        <router-link class="swb" :class="$route.params.utype==1?'active':''" to="/member/forget/1">企业供应商用户</router-link>
      </div>
