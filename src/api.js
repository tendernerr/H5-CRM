export default {
  ...
  resumeshow: '/home/resume/show',
    // 项目详情——沟通记录
    all_record: '/home/server/all_record',
  // 企业列表
  ...
  remark_resume: '/company/index/remarkResume',
    // 备注项目
    add_record: '/home/server/add_record',
  // 企业已下载项目列表
  ...
  // 获取订阅列表接口
  getCategoryList:'/home/resume/getCategoryList',
  // 保存订阅分类
  ...
  // 绑定采购信息
  purchasInformation:'/member/account/purchasInformation',
  // 发布采购
  publishPurchase:'/member/account/publishPurchase',
  // 上传图片
  memberRegIndex:'/member/reg/index',
  // 获取报价单位列表
  resumeQuotate:'/home/resume/quotate',
  //停止采购
  stopPurchase:'/home/resume/stopPurchase',
  //完成采购
  completePurchase:'/home/resume/completePurchase',
  // 获取我的行业分类
  getHouseholdaddress:'/home/short_video/getHouseholdaddress',
  // 获取完整手机号
  memberAccountGetMember:'/personal/interview/getMember',
  // 获取采购方项目列表
  personalServiceMyProject:'/personal/service/myProject',
  // 获取备项目
  homeResume_keepIndex:'/home/resume_keep/index',
  // 备案项目详情
